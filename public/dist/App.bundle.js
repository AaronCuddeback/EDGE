...
function autocomplete(input, latInput, lngInput) {
  if (!input) return; //skips this function from running if there is no address on page
...
function typeAhead(search) {
  ...
  searchInput.on('input', function () {
    ...
    // if there is no value, quit function
    if (!this.value) {
...
function loadPlaces(map) {
  var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 38.7;
  var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : -120.7;
